...
async def download_video(update: Update, context) -> None:
    ...
    # YouTube Link ကို မှန်အောင်ရှာခြင်း
    ...
    # Error ကင်းအောင် format ကို 'b' (best) ဟု အလွယ်ဆုံး သတ်မှတ်ခြင်း
    ydl_opts = {
        'format': 'b', 
        'outtmpl': 'video.%(ext)s',
